...
disk: Image
	dd if=Image of=linux-0.11.img bs=512 count=219
	dd if=/dev/zero of=linux-0.11.img skip=219 seek=219 bs=512 count=2661
...
clean:
	rm -f linux-0.11.img Image System.map tmp_make core boot/bootsect boot/setup
